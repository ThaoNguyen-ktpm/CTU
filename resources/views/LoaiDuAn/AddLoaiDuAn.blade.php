...
<div class="col">
<div class="container">
  <h2 class="text-weight">Thêm Loại Dự Án<small></small></h2>
...
<script>
	 $(document).ready(function() {
      $('.LoaiDuAn-form').submit(function(event) {
  ...
  function toast1({title='',message='',type='info',duration=2000}){
    ...
    function showSuccessToast1(){
      toast1({
        title: "Success",
        message: "Thêm Loại Dự Án Thành Công !",
        type:"success",
        duration:2000
      })
    }
