...
<div class="col">
<div class="container">
  <h2 class=" text-weight">Cập Nhật Vai Trò<small></small></h2>
  <form  method="post" class="needs-validation VaiTro-form" action="/VaiTro/update/{{$VaiTro->id}}" novalidate>
  @csrf
    <div class="group">
    <label>Tên Vai Trò <span style="color:red;">(*)</span></label>
      <input  id="usernameInput" name="TenVaiTro" value="{{ $VaiTro->TenVaiTro }}" type="text" class="form-control" required>
