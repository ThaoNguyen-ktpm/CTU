...
@endphp   
        ...
        <script>
            ...
            var table = $('#myTableAdmin').DataTable({
                ...
                columns: [
                    ...
                    //     data: null,
                    //     render: function(data, type, row) {
                    //     return '<form method="get" action="/Admin/updateview/'+row.id+'">@csrf <button class="btn btn-success"  type="submit"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;margin:0"></i></button></form>';
                    // }
                    // },
                    // {
                    //     data: null,
        ...
        $(document).ready(function() {
	$('.DeleteAdmin-form').click(function(event) {
