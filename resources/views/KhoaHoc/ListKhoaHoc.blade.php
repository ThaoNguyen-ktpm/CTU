...
@endphp   
        ...
        <a href=" /KhoaHoc/addview"  aria-expanded="false" >
        ...
        <script>
            ...
            var table = $('#myTableKhoaHoc').DataTable({
                ajax: {
                    url: "{{ route('KhoaHoc.data') }}",
                    dataSrc: 'data'
                },
                columns: [
                    { data: 'id' },
                    ...
                    { data: 'TenChungChi' },
                    {
                        ...
                        return '<form method="get" action="/KhoaHoc/updateview/'+row.id+'">@csrf <button class="btn btn-success"  type="submit"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;margin:0"></i></button></form>';
                    }
                    },
                    {
                        data: null,
                        render: function(data, type, row) {
                            return '<button class="btn btn-danger" onclick="deleteKhoaHoc(' + row.id + ')"><i class="fa-solid fa-trash-can" style="color: #ffffff;margin:0"></i></button>';
                        }
                    },
                    {
                        data: null,
                        render: function(data, type, row) {
                            return '<button class="btn btn-success DeleteKhoaHoc-form" ><a href="/Excel/ExportLop/'+row.id+'"><i class="fa-solid fa-file-export" style="color: #ffffff;margin:0"></i></a> </button>';
                        }
                    }
                ]
            });
        ...
        $(document).ready(function() {
	$('.DeleteKhoaHoc-form').click(function(event) {
